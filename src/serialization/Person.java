...
If you "deserialize an object" - this means taking binary data and turning that back into an object

What we are looking at in this tutorial is serializing files.
...
//So here, we have a simple class with a constructor and an overrided toString method.
...
//3) This is how I make the class serializable...
//Serializable doesn't actually have any methods in it...bit weird!
//So now let's go back to WriteObjects and point 4, and we will now try to write the Person object instances (mike and
//sue) to the "serializable.bin" file.
