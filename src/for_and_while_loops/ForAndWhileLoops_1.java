...
public class ForAndWhileLoops_1 {
	...
	public static void main(String[] args) {
		...
		for (int stomachSize = 40; stomachSize > 30; stomachSize = stomachSize - 2) {
			...
			//2nd part of bracket is the condition I want to test (similar to the while condition) - so in this
			//instance = While the value in the variable stomachSize is more than 30
			...
			//In this instance, I am now asking the value in the variable stomachSize to be decreased by a value of 2
		...
		System.out.println("Now you're nice and slim");
		...
		//Notice the printf in the above. This = (format, argument). Also the %d allows me to print the value in the
		//variable pintPrice. The %d is specific to integer primitive values.
		...
		for (int numberOfCards = 5; numberOfCards < 10 ; numberOfCards++){
